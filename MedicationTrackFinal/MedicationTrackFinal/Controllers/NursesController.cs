...
{     [Authorize(Roles ="Admin")]
    public class NursesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "NurseId,HireDate,FirstName,LastName")] Nurse nurse)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "NurseId,HireDate,FirstName,LastName")] Nurse nurse)
        {
            if (ModelState.IsValid)
            {
